...
# Portfolio data - Kandula Manasa's Projects
PORTFOLIO_ITEMS = [
    {
        'id': 1,
        'title': 'Calgary Crime Analysis',
        'description': 'Analyze crime patterns in Calgary to understand trends across time, location, and crime types using CPS open data.',
        'image': 'calgary_crime.jpg',
        'technologies': ['Python', 'Pandas', 'Matplotlib', 'Seaborn', 'Data Analysis'],
        'keyFeatures': [
            'Analyze trends by year, month, and season',
            'Visualize crime heatmaps and time-series',
            'Identify increases or decreases in crime over time'
        ]
    },
    {
        'id': 2,
        'title': 'Expense Tracker',
        'description': 'A web application to record, track, and manage daily expenses, helping users understand spending habits and improve financial planning.',
        'image': 'expense_tracker.jpg',
        'technologies': ['HTML', 'CSS', 'JavaScript', 'SQL', 'Python'],
        'keyFeatures': [
            'Record and categorize daily expenses',
            'Provide summaries and spending insights',
            'Simple UI for manual entry and review'
        ]
    },
    {
        'id': 3,
        'title': 'Data Science Portfolio',
        'description': 'Collection of data-focused projects demonstrating data preprocessing, basic predictive modeling and visualization skills.',
        'image': 'project3.jpg',
...
SKILLS = {
    'Programming Languages': ['Core Java', 'C (Basics)', 'Python (Basics)'],
    'Web Technologies': ['HTML', 'CSS', 'JavaScript'],
    'Databases': ['SQL'],
    'Core Concepts': ['Data Structures & Algorithms', 'Object-Oriented Programming (OOPs)', 'SDLC'],
